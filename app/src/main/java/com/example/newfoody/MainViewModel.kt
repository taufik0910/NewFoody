...
class MainViewModel @ViewModelInject constructor(
    ...
    var receipesResponse: MutableLiveData<NetworkResult<Antah>> = MutableLiveData()
    ...
    private fun handleFoodRecipesResponse(response: Response<Antah>): NetworkResult<Antah>? {
        when {
